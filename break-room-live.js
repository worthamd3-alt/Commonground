...
function zb({
  ...
  return (0, i.jsxs)("div", {
    style: {
      ...
      alignItems: "center",
      justifyContent: "center",
      // Top inset matters as much as the bottom one: the Admin console's only
      // exit is its back button, and without this it renders under the notch.
    ...
    children: [(0, i.jsx)("style", {
      ...
      style: {
        width: 400,
        maxWidth: "100%",
        height: "min(780px, calc(100dvh - 40px - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px)))",
        background: d.paper,
        borderRadius: 34,
        overflow: "hidden",

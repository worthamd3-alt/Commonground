  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: (() => {
          let who = e.filter(s => s.month === r).sort((s, l) => s.day - l.day).map(s => {
            let parts = String(s.name || "").trim().split(/\s+/);
            return parts.length > 1 ? parts[0] + " " + parts[parts.length - 1][0] + "." : parts[0]
          });
          // Names while the list is short; a count once it isn't.
          let list = who.length <= 3 ? who.length === 1 ? who[0] : who.slice(0, -1).join(", ") + " and " + who[who.length - 1] : who.slice(0, 2).join(", ") + " and " + (who.length - 2) + " more";
          return [list, " \u2014 tap to celebrate"]
        })()
      }), (0, i.jsx)(Rv, {
        people: e.filter(s => s.month === r),
        photoFor: a

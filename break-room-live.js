      ...
      children: [showMockSections && (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: [(0, i.jsxs)("label", {
            ...
            children: [hireDraft.photoDataUrl ? (0, i.jsx)("img", {
              ...
              onChange: async ev => {
                ...
                if (!file) return;
                let dataUrl = await kv(file, 600, .85);
                setHireDraft(pv => ({
                  ...pv,
          ...
          onClick: async () => {
            ...
            setHireBusy(!1), msg ? setHireErr(msg) : setHireDraft({
              name: "",
              title: "",
              dept: "",
              site: "oxford",
...
function zb({
  ...
  let ae = async S => {
    ...
    if (S.photoDataUrl) {
      ...
      path = "hires/" + Date.now() + ".jpg";
      let {
        error: upErr
      } = await F.storage.from("people-photos").upload(path, blob, {
        contentType: "image/jpeg"
      });
    ...
    return insErr ? insErr.message : (Zn(), ra(), null)

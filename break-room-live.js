    ...
    children: [(0, i.jsx)(Iv, {
      ...
      children: [(0, i.jsx)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: [deptMemberCounts[f.name] || 0, (deptMemberCounts[f.name] || 0) === 1 ? " member" : " members"]
        })]
      })]
    }, f.id))]
  })
...
function zb({
  ...
  let [Jv, Xv] = (0, I.useState)([]), eh = async S => {
    ...
    if (U ? N.delete(S) : (N.add(S), L && N.add(L)), u(N), U) {
      ...
      if (_t(), Y) {
        f(Y.message), aa(Y.message), window.alert("Join failed: " + (Y.message || "") + " | code " + (Y.code || "?") + " | " + (Y.details || "")), h();
        return
      }
      ...
      if (_t(), J) {
        f(J.message), aa(J.message), window.alert("Join failed: " + (J.message || "") + " | code " + (J.code || "?") + " | " + (J.details || "")), h();
        return
      }
    }

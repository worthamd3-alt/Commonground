...
var wvArchive = [{
  ...
  policy: [{
    ...
    b: "Patient information belongs in Google Chat, never in The Break Room. Keep patient details out of posts, department chats, group messages, profiles, and any community area."
  }, {
...
var LUNCH_SITES = [["tupelo-asc", "Tupelo ASC"], ["tupelo-clinic", "Tupelo Clinic"], ["tupelo-pt", "Tupelo PT"], ["oxford-asc", "Oxford ASC"], ["oxford-clinic", "Oxford Clinic"], ["oxford-pt", "Oxford PT"]];
var lunchSiteLabel = raw => {
  let v = String(raw || "");
  if (v === "oxford") return "Oxford";
  if (v === "tupelo") return "Tupelo";
  if (v === "both" || !v) return "All sites";
  let picked = v.split(",").map(k => {
    let hit = LUNCH_SITES.filter(pair => pair[0] === k.trim())[0];
    return hit ? hit[1] : null
  }).filter(Boolean);
  return picked.length === LUNCH_SITES.length ? "All sites" : picked.length ? picked.join(", ") : "All sites"
};
var Av = (e, t = 1400, a = .82) => new Promise(r => {
  ...
  eb = [{
    ...
    body: "Anything sensitive belongs in Google Chat - keep it out of posts, chats, and profiles here."
  }],
...
function db({
  ...
  let r = new Date().getMonth() + 1,
    ...
    todayFolks = e.filter(s => s.month === r && s.day === todayDay);
  if (!n) return null;
  return (0, i.jsxs)("div", {
    onClick: t,
    style: {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [todayFolks.length ? (0, i.jsx)("div", {
        style: {
          background: "rgba(224,154,56,0.14)",
          border: "1px solid rgba(224,154,56,0.45)",
          borderRadius: 13,
          padding: "10px 12px",
          marginBottom: 11
        },
        children: (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(Rv, {
            ...
            children: [(0, i.jsx)("div", {
              ...
              children: todayFolks.length > 1 ? "Anniversaries today" : "Anniversary today"
            }), (0, i.jsx)("div", {
              style: {
                fontFamily: D,
                fontWeight: 700,
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(Rv, {
            ...
            children: [(0, i.jsx)("div", {
              ...
              children: todayFolks.length > 1 ? "Birthdays today" : "Birthday today"
            }), (0, i.jsx)("div", {
              style: {
                fontFamily: D,
                fontWeight: 700,
              ...
              children: todayFolks.map(s => s.name).join(", ")
            })]
          })]
        })
      }) : null, (0, i.jsxs)("div", {
...
function Lv({
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [t && e.kind !== "new_hire" && e.kind !== "recognition" && (0, i.jsxs)("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 5,
    ...
    }), e.kind === "recognition" && Sd.some(rcx => rcx.id === e.recCat) ? (() => {
      let rc = Gp(e.recCat),
        RcIcon = rc.icon;
      return (0, i.jsxs)("div", {
        style: {
    ...
    }) : null, e.kind !== "new_hire" && e.kind !== "recognition" && (0, i.jsxs)("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 10,
      ...
      children: e.kind === "recognition" && (e.text || "").indexOf("\n\n") > 0 ? (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)("div", {
          style: {
            fontFamily: D,
            fontWeight: 700,
          ...
          children: e.text.slice(0, e.text.indexOf("\n\n"))
        }), e.text.slice(e.text.indexOf("\n\n") + 2)]
      }) : e.text
    }), e.kind === "recognition" && e.hirePhoto ? (0, i.jsx)("img", {
      src: e.hirePhoto,
      alt: "",
      onClick: () => window.open(e.hirePhoto, "_blank"),
      style: {
        display: "block",
        width: "100%",
        height: "auto",
    ...
    }) : null, e.canDelete && a && (0, i.jsx)("button", {
      onClick: () => {
      ...
      children: e.mine ? "Delete" : "Remove post"
    }), e.canDelete && e.pinned && cardUnpin ? (0, i.jsx)("button", {
      onClick: () => {
        window.confirm("Unpin this? It stays in the feed, it just stops being highlighted.") && cardUnpin(e.id)
      },
      style: {
        marginTop: 10,
        marginLeft: 14,
      ...
      children: "Unpin"
    }) : null, onAddComment && (0, i.jsxs)("div", {
      style: {
        marginTop: 12,
        paddingTop: 11,
...
function wb({
  ...
  let [E, P] = (0, I.useState)(""), [composerOpen, setComposerOpen] = (0, I.useState)(!1), [W, K] = (0, I.useState)({
    name: "Everyone",
    id: null
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(() => {
      let dayKey = dd => dd.getFullYear() + "-" + String(dd.getMonth() + 1).padStart(2, "0") + "-" + String(dd.getDate()).padStart(2, "0"),
        todayKey = dayKey(new Date()),
        lunchToday = (lunchRows || []).filter(L => L.on_date >= todayKey).sort((A, B) => A.on_date < B.on_date ? -1 : 1).slice(0, 3),
        lunchSoon = (() => {
          if (!lunchToday.length) return !1;
          let parts = String(lunchToday[0].on_date).split("-"),
            when = new Date(+parts[0], +parts[1] - 1, +parts[2]);
          return Math.round((when - new Date(new Date().setHours(0, 0, 0, 0))) / 864e5) <= 1
        })(),
        lunchDayLabel = key => {
          if (key === todayKey) return "Today";
          let parts = String(key).split("-"),
            when = new Date(+parts[0], +parts[1] - 1, +parts[2]),
            days = Math.round((when - new Date(new Date().setHours(0, 0, 0, 0))) / 864e5);
          return days === 1 ? "Tomorrow" : days < 7 ? when.toLocaleDateString("en-US", {
            weekday: "long"
        ...
        siteLabel = (lunchSite => lunchSiteLabel(lunchSite).toUpperCase());
      return lunchToday.length && lunchSoon ? (0, i.jsx)("div", {
        style: {
          margin: "0 14px 12px",
          background: d.honeySoft,
        ...
        children: (0, i.jsxs)("div", {
          children: [(0, i.jsx)("div", {
            ...
            children: lunchToday[0] && lunchToday[0].on_date === todayKey ? "LUNCH TODAY" : "LUNCH COMING UP"
            ...
            children: [(0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)("span", {
                ...
                children: lunchDayLabel(L.on_date) + " \xB7 " + L.vendor
              }), (0, i.jsx)("span", {
                style: {
                  fontFamily: p,
                  fontSize: 10,
      ...
      onClick: composerOpen ? void 0 : () => setComposerOpen(!0),
      style: {
        background: d.card,
        border: "1px solid " + d.line,
        borderRadius: 18,
        padding: composerOpen ? 14 : 11,
        cursor: composerOpen ? "default" : "pointer"
      },
      children: composerOpen ? [(0, i.jsxs)("div", {
        style: {
          display: "flex",
          gap: 10
        },
        ...
        children: [(0, i.jsx)(Ne, {
          ...
          children: "Share something with the team..."
        })]
      })]
      ...
      let dayKey = dd => dd.getFullYear() + "-" + String(dd.getMonth() + 1).padStart(2, "0") + "-" + String(dd.getDate()).padStart(2, "0"),
        todayKey = dayKey(new Date()),
        rows = (lunchRows || []).filter(L => L.on_date >= todayKey).sort((A, B) => A.on_date < B.on_date ? -1 : 1).slice(0, 3);
      if (!rows.length) return null;
      let firstParts = String(rows[0].on_date).split("-"),
        firstWhen = new Date(+firstParts[0], +firstParts[1] - 1, +firstParts[2]);
      if (Math.round((firstWhen - new Date(new Date().setHours(0, 0, 0, 0))) / 864e5) <= 1) return null;
      let label = key => {
        let parts = String(key).split("-"),
          when = new Date(+parts[0], +parts[1] - 1, +parts[2]),
          days = Math.round((when - new Date(new Date().setHours(0, 0, 0, 0))) / 864e5);
        return days < 7 ? when.toLocaleDateString("en-US", {
          weekday: "long"
        }) : when.toLocaleDateString("en-US", {
          weekday: "short",
          month: "short",
      ...
      return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: "Lunch coming up"
        }), (0, i.jsx)("div", {
          style: {
            padding: "10px 15px"
          },
          children: rows.map((L, li) => (0, i.jsxs)("div", {
            style: {
              marginTop: li ? 8 : 0
            },
            children: [(0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)("span", {
                ...
                children: label(L.on_date) + " \xB7 " + L.vendor
              }), (0, i.jsx)("span", {
                style: {
                  fontFamily: p,
                  fontWeight: 800,
                ...
                children: lunchSiteLabel(L.site).toUpperCase()
              })]
            }), L.note ? (0, i.jsx)("div", {
              style: {
                fontFamily: p,
...
function DoctorsScreen({ docs: list = [], back: onBack, photoFor: photo = () => null, openDoc: onOpen = () => {} }) {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      style: { background: d.pine, padding: "14px 16px 18px", color: "#F5F1E8", flexShrink: 0 },
      children: [(0, i.jsxs)("button", {
        onClick: onBack,
      ...
      style: { padding: 14, flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch" },
      children: [(0, i.jsx)("input", {
        value: q,
        ...
        children: [(0, i.jsx)("div", {
          ...
          (0, i.jsxs)("div", { style: { minWidth: 0 }, children: [
            ...
            x.credential && (0, i.jsx)("div", {
              style: { fontFamily: p, fontSize: 11.5, fontWeight: 700, color: d.pine, marginTop: 1 },
              children: x.credential
            }),
            (0, i.jsx)("div", {
              style: { fontFamily: p, fontSize: 12, color: d.sub, marginTop: 1 },
...
function DoctorScreen({ doc: e, back: onBack, photoFor: photo = () => null, onMessage: onMsg = null }) {
  return (0, i.jsxs)("div", {
    style: { height: "100%", display: "flex", flexDirection: "column" },
    children: [(0, i.jsxs)("div", {
      style: { background: d.pine, padding: "14px 16px 22px", color: "#F5F1E8", flexShrink: 0 },
      children: [(0, i.jsxs)("button", {
        onClick: onBack,
        style: { background: "none", border: "none", color: "rgba(245,241,232,0.75)", display: "flex",
                 alignItems: "center", gap: 3, fontFamily: p, fontSize: 13, fontWeight: 600,
        ...
        (0, i.jsxs)("div", { style: { minWidth: 0 }, children: [
          ...
          e.credential && (0, i.jsx)("div", {
            style: { fontFamily: p, fontSize: 12.5, fontWeight: 700, opacity: .95, marginTop: 3,
                     letterSpacing: ".01em" },
            children: e.credential
          }),
          (0, i.jsx)("div", {
            style: { fontFamily: p, fontSize: 13, opacity: .8, marginTop: 2 },
            children: e.specialty
          })
        ]})]
      })]
    }), (0, i.jsxs)("div", {
      style: { padding: 16, flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch" },
      children: [
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(Ne, {
            ...
            children: [(0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)(ca, {
                size: 11
              }), _.length ? _.map((dm, dmIx) => (0, i.jsxs)("span", {
                style: {
                  display: "inline-flex",
                  alignItems: "center",
                  gap: 4,
                ...
                children: [dmIx > 0 && !(r && onRemoveDept) ? (0, i.jsx)("span", {
                  style: {
                    marginRight: 4,
                    opacity: .6
                  },
                  children: "\xB7"
                }) : null, dm.name, r && onRemoveDept ? (0, i.jsx)("button", {
                  onClick: ev => {
...
function Rb({
  ...
  announceLunch: doAnnounceLunch = null,
  birthdays: W = [],
  addBirthday: K,
  editBirthday: B,
  removeBirthday: X,
  ...
  let Se = l === "manager",
    ...
    [lunchMsg, setLunchMsg] = (0, I.useState)(""),
    [bdayMsg, setBdayMsg] = (0, I.useState)(""),
    ...
    [recPhotoErr, setRecPhotoErr] = (0, I.useState)(""),
    ...
    tl = () => {
      ...
      let y = {
        photoDataUrl: ge.photoDataUrl || null,
        cat: ge.cat,
        title: ge.title.trim(),
        body: ge.body.trim(),
        link: ge.link.trim(),
    ...
    Hn = y => {
      il(y), Or(y.name), Wn("2000-" + String(y.month).padStart(2, "0") + "-" + String(y.day).padStart(2, "0"))
    },
    qn = () => {
      il(null), Or(""), Wn("")
    },
    _d = async () => {
      if (!Nn.trim()) return setBdayMsg("Add a name first.");
      if (!So) return setBdayMsg("Pick a date first.");
      let y = new Date(So + "T00:00:00");
      if (isNaN(y.getTime())) return setBdayMsg("That date didn't read properly - try picking it again.");
      let M = {
        name: Nn.trim(),
        month: y.getMonth() + 1,
        day: y.getDate()
      };
      if (!Nt && (W || []).some(row => Tr(row.name) === Tr(M.name) && row.month === M.month && row.day === M.day)) return setBdayMsg(M.name + " is already on the roster for that day.");
      setBdayMsg("");
      let ok = await (Nt ? B(Nt, M) : K(M));
      if (ok === !1) return setBdayMsg("Couldn't save that - see the error above.");
      qn()
    },
    [ot, $n] = (0, I.useState)(!1),
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [showMockSections && (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: "Shows on Home from now until the day it happens. Pick every site the lunch covers."
        }), (0, i.jsxs)("div", {
          style: {
            display: "flex",
            gap: 7,
          ...
          children: LUNCH_SITES.map(pair => {
            let picked = String(lunchDraft.site || "").split(",").map(x => x.trim()).filter(Boolean),
              on = picked.indexOf(pair[0]) !== -1;
            return (0, i.jsx)("button", {
              onClick: () => setLunchDraft(pv => {
                let cur = String(pv.site || "").split(",").map(x => x.trim()).filter(x => x && LUNCH_SITES.some(z => z[0] === x)),
                  next = cur.indexOf(pair[0]) !== -1 ? cur.filter(x => x !== pair[0]) : cur.concat([pair[0]]);
                return {
                  ...pv,
                  site: next.join(",")
                }
              ...
              style: {
                background: on ? d.honey : "rgba(245,241,232,0.08)",
                border: "1px solid " + (on ? d.honey : "rgba(245,241,232,0.18)"),
                borderRadius: 999,
                padding: "6px 11px",
                fontFamily: p,
                fontWeight: 700,
                fontSize: 11.5,
                color: on ? d.pine : "rgba(245,241,232,0.75)",
                cursor: "pointer"
              },
              children: pair[1]
            }, pair[0])
          ...
          children: lunchMsg
        }) : null, (lunchRows || []).length ? (lunchRows || []).map(L => (0, i.jsxs)("div", {
          style: {
            display: "flex",
            alignItems: "center",
            gap: 9,
          ...
          children: [(0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
              ...
              children: [L.vendor, " · ", lunchSiteLabel(L.site)]
            }), (0, i.jsx)("div", {
              style: {
                fontFamily: p,
                fontSize: 11,
          ...
          }), doAnnounceLunch ? (0, i.jsx)("button", {
            onClick: async () => {
              setLunchMsg(await doAnnounceLunch(L))
            },
            style: {
              background: "transparent",
              border: "1px solid rgba(226,162,74,0.5)",
              borderRadius: 999,
              padding: "4px 11px",
              fontFamily: p,
              fontWeight: 700,
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: [(0, i.jsx)("select", {
            value: So ? So.slice(5, 7) : "",
            onChange: y => Wn(y.target.value ? "2000-" + y.target.value + "-" + (So ? So.slice(8, 10) : "01") : ""),
            style: {
              ...re,
              flex: 1.4,
              appearance: "none"
            ...
            children: [(0, i.jsx)("option", {
              value: "",
              children: "Month"
            })].concat(["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"].map((mName, mIx) => (0, i.jsx)("option", {
              value: String(mIx + 1).padStart(2, "0"),
              children: mName
            }, mName)))
          }), (0, i.jsx)("select", {
            value: So ? So.slice(8, 10) : "",
            onChange: y => Wn((So ? So.slice(0, 8) : "2000-01-") + y.target.value),
            style: {
              ...re,
              flex: 1,
              appearance: "none"
            ...
            children: [(0, i.jsx)("option", {
              ...
              length: 31
            }, (dv, dIx) => (0, i.jsx)("option", {
              value: String(dIx + 1).padStart(2, "0"),
              children: String(dIx + 1)
            }, dIx)))
          }), (0, i.jsx)("button", {
            onClick: _d,
            style: {
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: "Post fresh or paste one in from Facebook \u2014 then Share any post back out to SOG's socials. It posts to the feed and notifies everyone, stays pinned for 24 hours, and keeps its place on the Recognition board."
        }), Bn ? (0, i.jsxs)("div", {
          children: [(0, i.jsx)("div", {
            style: {
              display: "flex",
            ...
            style: {
              ...
              alignItems: "center",
              gap: 9,
              marginBottom: recPhotoErr ? 6 : 12,
              cursor: "pointer"
            },
            children: [ge.photoDataUrl ? (0, i.jsx)("img", {
              src: ge.photoDataUrl,
              alt: "",
              style: {
                width: 44,
              ...
              children: ge.photoDataUrl ? "Swap photo" : "Add a photo or screenshot - optional"
            }), ge.photoDataUrl ? (0, i.jsx)("span", {
              onClick: y => {
                y.preventDefault(), y.stopPropagation(), setRecPhotoErr(""), _t({
                  ...ge,
                  photoDataUrl: null
                })
              },
              ...
              onChange: async ev => {
                let file = ev.target.files && ev.target.files[0];
                if (ev.target.value = "", !file) return;
                setRecPhotoErr("");
                let dataUrl = await Av(file, 1400, .85);
                // Av hands back the ORIGINAL when the browser can't decode it
                // (HEIC straight off an iPhone camera does this).
                if (!dataUrl || dataUrl.indexOf("data:image/jpeg") !== 0) {
                  setRecPhotoErr("That photo format isn't supported here. On an iPhone, take a screenshot of it and add that instead.");
                  return
                }
                _t(prev => ({
                  ...prev,
...
#SpecialtyOrthopedicGroup`;
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
              ...
              children: [(0, i.jsx)("div", {
                ...
                children: [M.name, " \xB7 ", Z ? Math.max(1, Math.ceil((y.pinUntil - Date.now()) / 864e5)) + "d left" : "expired", G ? " \xB7 on the feed" : " \xB7 not on the feed"]
              })]
            }), !G && doRepostRec ? (0, i.jsx)("button", {
              onClick: () => doRepostRec(y),
              style: {
                background: "none",
                border: "none",
                padding: 0,
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: "The poll on Home. Everyone sees the first question they haven't answered, one at a time, in this order. Add a new one and it reaches people who are already caught up."
        }), vo ? (0, i.jsxs)("div", {
          children: [(0, i.jsx)("input", {
            value: Ct,
...
function Eb({
  ...
  let X = kd.filter(q => e.has(q.id) || q.subs && q.subs.some(ke => e.has(q.id + ":" + ke))),
    ...
    It = K,
    [wsPick, setWsPick] = (0, I.useState)(null),
    [$, me] = (0, I.useState)(!1),
    [ie, We] = (0, I.useState)({
      name: "",
      home: "",
      ...
      children: [(0, i.jsx)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: [
            ...
            let wsOn = (wsPick || (v && v.work_site) || "both") === wsKey;
            return (0, i.jsx)("button", {
              onClick: async () => {
                let prev = wsPick;
                setWsPick(wsKey), await r({
                  work_site: wsKey
                }) || setWsPick(prev)
              },
              style: {
...
function zb({
  ...
  let Rr = S => Oe(F.from("challenges").insert({
    ...
    }, announceLunch = async row => {
      // Same reasoning as announceMerch: a feed post fires the working
      // trigger and leaves something behind for anyone who missed the buzz.
      try {
        let when = (key => {
            let now = new Date(),
              pad = n => (n < 10 ? "0" : "") + n,
              keyFor = dt => dt.getFullYear() + "-" + pad(dt.getMonth() + 1) + "-" + pad(dt.getDate()),
              tomorrow = new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1);
            if (key === keyFor(now)) return "today";
            if (key === keyFor(tomorrow)) return "tomorrow";
            let parts = String(key || "").split("-"),
              dt = new Date(+parts[0], +parts[1] - 1, +parts[2]);
            return isNaN(dt.getTime()) ? String(key || "") : "on " + dt.toLocaleDateString("en-US", {
              weekday: "long",
              month: "short",
              day: "numeric"
            })
          })(row.on_date),
          lines = ["Vendor lunch " + when + " \u2014 " + row.vendor + " at " + lunchSiteLabel(row.site) + "."];
        row.note && lines.push(row.note);
        let {
          error: postErr
        } = await F.from("feed_posts").insert({
          author_id: e.id,
  ...
  let el = async (S, L, T) => {
    ...
    let hp = await F.from("feed_posts").select("hire_photo_path").in("kind", ["new_hire", "recognition"]).not("hire_photo_path", "is", null);
  ...
  (0, I.useEffect)(() => {
    let alive = !0;
    F.from("physicians").select("id, last_name, name, specialty, credential, towns, bio, profile_id")
  ...
  let Ga = t && t.display_name || mo,
    ...
    ol = async (S, L) => {
      ...
      ot(""), oa(S.data || []), Cd(L.data || []), il((T.data || []).map(N => ({
        ...
        photoPath: N.photo_path || null,
        feedPostId: N.feed_post_id || null
  ...
  let ae = async S => {
    ...
    if (S.photoDataUrl) {
      try {
        let blob = await (await fetch(S.photoDataUrl)).blob();
        let tryPath = "hires/rec-" + Date.now() + ".jpg";
        let {
          error: upErr
        } = await F.storage.from("people-photos").upload(tryPath, blob, {
          contentType: "image/jpeg"
        });
        // A photo that won't upload must never cost the whole recognition —
        // but a silent failure is worse than a lost photo, so say so.
        upErr ? photoWarn = "Photo didn't attach: " + upErr.message : recPath = tryPath
      } catch (ex) {
        photoWarn = "Photo didn't attach."
      }
    }
    let {
      data: recRow,
      error: recErr
    } = await F.from("recognition").insert({
      photo_path: recPath,
      cat: S.cat,
      title: S.title,
      body: S.body,
    ...
    if (recErr) return ot(recErr.message), !1;
    ot("");
    try {
      let lines = [S.title];
      S.body && lines.push(S.body);
      S.link && lines.push(S.link);
      let {
        data: postRow
      } = await F.from("feed_posts").insert({
        author_id: e.id,
        ...
        kind: "recognition",
        rec_cat: S.cat || null,
        hire_photo_path: recPath,
        pinned_until: new Date(Date.now() + 864e5).toISOString()
      }).select("id").single();
      // Remember which post this recognition created, so removing one
      // can remove the other instead of leaving an orphan behind.
      postRow && postRow.id && await F.from("recognition").update({
        feed_post_id: postRow.id
      }).eq("id", recRow.id)
    } catch (ex) {}
    return Lo(), Zn(), ra(), photoWarn && ot(photoWarn), !0
  }, repostRec = async row => {
    try {
      let lines = [row.title];
      row.body && lines.push(row.body);
      row.link && lines.push(row.link);
      let {
        data: postRow,
        error: postErr
      } = await F.from("feed_posts").insert({
        ...
        audience_dept: null,
        kind: "recognition",
        rec_cat: row.cat || null,
        hire_photo_path: row.photoPath || null,
        pinned_until: new Date(Date.now() + 864e5).toISOString()
      }).select("id").single();
      if (postErr) return ot(postErr.message), !1;
      postRow && postRow.id && await F.from("recognition").update({
        feed_post_id: postRow.id
      }).eq("id", row.id);
      return ot(""), Lo(), Zn(), ra(), !0
    } catch (ex) {
      return ot(String(ex.message || ex)), !1
    }
  }, re = (S, L) => {
    let T = {};
    ...
    // Take the feed post with it — the two were created together.
    try {
      let {
        data: linked
      } = await F.from("recognition").select("feed_post_id").eq("id", S).single();
      linked && linked.feed_post_id && await F.from("feed_posts").delete().eq("id", linked.feed_post_id)
    } catch (ex) {}
    let ok = await ae(F.from("recognition").delete().eq("id", S));
    return Zn(), ok
  }, Rd = async S => {
    let L = {
      ...Hn,
  ...
  let Nv = async () => {
    ...
    let {
      error: L
    } = await F.from("feed_posts").update({
      pinned_until: null
    }).eq("id", S);
    if (L) {
      Z(L.message);
    ...
    let {
      data: S,
      error: L
    } = await F.from("feed_posts").select("id, body, audience, audience_dept, created_at, author_id, kind, rec_cat, hire_name, hire_title, hire_dept, hire_site, hire_works_with, hire_photo_path, pinned_until, departments(name), profiles(display_name, department_members(department_id))").order("created_at", {
      ascending: !1
    }).limit(60);
    if (L) {
      Z(L.message);
    ...
    Z(""), y((S || []).map(T => ({
      ...
      createdAt: new Date(T.created_at).getTime() || 0,
      text: T.body,
      comments: commentsByPost[T.id] || [],
      kind: T.kind || "post",
      recCat: T.rec_cat || null,

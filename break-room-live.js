...
var i = Qa(Xs()),
  ...
  Hk = {
    "Front Desk / Appointments": "Dana Whitfield",
    "Nursing / Clinical": "Angela Pope",
    "Physical Therapy": "Marcus Bell"
  },
  Ys = [{
    id: "furniture",
    name: "Furniture",
...
var wv = [{
  ...
  readBy: ["Angela Pope", "Marcus Bell", "Dana Whitfield"],
  notYet: ["Kayla Duncan", "Tyler Fox", "Rosa Jimenez", "Reggie Sims", "Sam Odom"]
}, {
  official: !0,
  from: "SOG Administration",
  role: "Company",
  time: "2h",
  audience: "Everyone",
  title: "Tupelo expansion - new PT wing opens Aug 18",
  body: "Doubling our physical therapy footprint at the Tupelo campus. Staff tours the week prior - sign up through your department lead.",
  readBy: ["Angela Pope", "Kayla Duncan", "Tyler Fox", "Marcus Bell", "Dana Whitfield"],
  notYet: ["Rosa Jimenez", "Reggie Sims", "Sam Odom"]
}, {
  official: !0,
  from: "Cody Atkins",
  role: "COO",
  time: "5h",
  audience: "Everyone",
  title: "Pickleball Alliance kickoff - Saturday, Oxford courts",
  body: "Free community clinic this Saturday, 9am. All staff and families welcome, no experience needed.",
  readBy: ["Angela Pope", "Kayla Duncan", "Marcus Bell", "Reggie Sims"],
  notYet: ["Tyler Fox", "Dana Whitfield", "Rosa Jimenez", "Sam Odom"]
}, {
  official: !0,
  from: "People & Culture",
  role: "HR",
  time: "1d",
  audience: "Everyone",
  title: "Flu shots at every location next week",
  body: "Walk up anytime Mon-Thu. No appointment, on the clock.",
  readBy: ["Dana Whitfield", "Sam Odom", "Rosa Jimenez", "Angela Pope", "Kayla Duncan", "Tyler Fox"],
  notYet: ["Marcus Bell", "Reggie Sims"]
}];
var qp = {};
kd.forEach(e => {
...
var Av = (e, t = 1400, a = .82) => new Promise(r => {
  ...
  Yk = [{
    ...
    dept: "Nursing / MA",
    loc: "Oxford",
    school: "Northeast MS CC",
    tags: ["pickle", "food"],
    details: {
      pickle: "4.0 level, compete in tournaments around North Mississippi. Looking for someone to drill or take lessons with on weeknights.",
      food: "Meal-prep obsessed and unofficial potluck coordinator. Always testing new recipes on the team."
    }
  }, {
    name: "Kayla Duncan",
    ...
    tags: ["pickle", "art"],
    details: {
      pickle: "3.5 and climbing. Just learned to dink. Looking for a patient partner to rally with after work.",
      art: "Pottery and ceramics - throwing on the wheel most weekends. Happy to show anyone the basics."
    }
  }, {
    name: "Tyler Fox",
    cred: "RT",
    ...
    tags: ["cars", "music"],
    details: {
      cars: "Restoring a '69 Camaro, second project car. Bring yours to the lot Friday and let's talk shop.",
      music: "Lead guitar in a classic-rock cover band. Looking for a drummer who can commit to weekends."
    }
  }, {
    name: "Marcus Bell",
    cred: "PT",
    ...
    details: {
      sports: "Run the Tuesday-night rec basketball league. We need one more for 5-on-5 - all skill levels welcome.",
      outdoors: "Bass fishing and deer season. Sardis Lake most weekends if you want to tag along."
    }
  }, {
    name: "Dana Whitfield",
    ...
    tags: ["music", "food"],
    details: {
      music: "Sing alto in my church choir and mess around on piano. Always down to swap playlists.",
      food: "Certified BBQ judge, no exaggeration. Ask me where to actually eat in Tupelo."
    }
  }, {
    name: "Rosa Jimenez",
    ...
    tags: ["art", "books"],
    details: {
      art: "Watercolor and hand-lettering. I sell prints at the Calhoun City market on Saturdays.",
      books: "Two books a week, mostly mystery. Trying to start a lunch-hour book club - join me."
    }
  }, {
    name: "Reggie Sims",
    role: "Surgery Scheduler",
    dept: "Surgery",
    loc: "Columbus",
    school: "Alcorn State",
    tags: ["sports", "music"],
    details: {
      sports: "Ole Miss football die-hard. Our tailgate crew always has room and always has food.",
      music: "DJ on the side - weddings and parties. Hit me up if you've got an event coming."
    }
  }, {
    name: "Sam Odom",
    role: "Administration",
    ...
    tags: ["books", "outdoors"],
    details: {
      books: "Sci-fi and history mostly. Happy to lend from my shelf - it's overflowing.",
      outdoors: "Backpacking and trail running. Planning a Sipsey Wilderness trip this fall, could use company."
    }
  }],
  Qk = [{
    id: "t1",
    ...
    color: "#B4532F",
    icon: eo,
    last: "Tyler: Bringing the '69 Camaro Friday \u{1F527}",
    unread: 3
  }, {
    id: "t2",
    name: "Dana Whitfield",
    last: "Sounds good - see you at the Tupelo tour!",
    unread: 0
  }, {
    id: "t3",
    name: "Oxford Front Desk",
    group: !0,
    color: d.pine,
    icon: Xt,
    last: "Angela: covered the 8am, all good",
    unread: 0
  }, {
    id: "t4",
    name: "Cody Atkins",
    last: "Appreciate you jumping on the Alliance thing.",
    unread: 1
  }],
  bv = [{
    id: "team",
  ...
  Zk = [{
    who: "You",
    me: !0,
    text: "Bobby S. - walk-in, on his way. Flag me when he's checked in.",
    time: "9:32",
    age: "3h 09m",
    reminded: 2,
    next: "5:00 PM"
    ...
    who: "Dana W.",
    text: "Got him at the front - rooming now.",
    time: "9:38"
  }],
  eb = [{
    icon: Yt,
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [n, " this month \u2014 tap to celebrate our team"]
      }), (0, i.jsx)(Rv, {
...
function yb({
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [e.length, " featured ", e.length === 1 ? "item" : "items", " \xB7 ", t.open ? "ordering open" : "ordering closed for now", " \u2014 tap to shop"]
    })]
  })
}
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("button", {
          ...
          children: n === "A" ? "You're in \u2713" : "Back " + e.sideA.name
        }), (0, i.jsx)("button", {
          onClick: () => c("B"),
          disabled: !!n,
          style: {
          ...
          children: n === "B" ? "You're in \u2713" : "Back " + e.sideB.name
        })]
      }), n && (0, i.jsxs)("button", {
        style: {
          width: "100%",
        ...
        children: [(0, i.jsx)(Yt, {
          size: 14
        }), "Donate to your side's cause ", (0, i.jsx)(br, {
          size: 12
        })]
      }), (0, i.jsxs)("div", {
        style: {
        ...
        children: [(0, i.jsx)(Qt, {
          ...
          children: "You give directly on each charity's page - CommonGround never handles the money, it just tracks who's in and celebrates the winner."
        })]
      })]
    })]
  })
...
function Sb({
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(Iv, {
      ...
      children: kd.map(f => {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)("div", {
            ...
            children: g ? f.subs.length + " groups" + (b ? " \xB7 " + b + " joined" : "") : f.members + (m ? 1 : 0) + " members"
          }), g ? (0, i.jsxs)("button", {
            onClick: k => {
      ...
      icon: ca,
      text: "Departments",
      note: "Your team channels"
    }), En.map(f => (0, i.jsxs)("div", {
      onClick: () => a({
        ...f,
        dept: !0,
        color: d.pine,
...
function Lb({
  ...
  }, b = w => (w.department_members || []).map(_ => g(_.department_id)).filter(Boolean), k = c.trim().toLowerCase(), v = e.filter(w => r && h ? !0 : w.active !== !1).filter(w => k ? [w.display_name, w.title, w.dept].concat(b(w)).join(" ").toLowerCase().indexOf(k) !== -1 : !0), x = e.filter(w => w.active === !1).length;
  return (0, i.jsxs)("div", {
    style: {
      padding: "4px 16px 20px"
    },
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(Ne, {
            ...
            children: [(0, i.jsxs)("div", {
              ...
              children: [(0, i.jsx)(ca, {
                size: 11
              }), _.length ? _.join(" \xB7 ") : w.dept || "No department yet"]
            })]
          })]
...
var Tb = [{
    id: "A-2291",
    hash: "3f9a1c",
    content: "Bobby S. - walk-in, on his way. Let me know when he checks in.",
    scope: "Oxford front desk (11)",
    date: "Aug 3, 2026",
    retain: "Aug 3, 2032",
    events: [{
      t: "09:32:04",
    ...
    id: "A-2288",
    hash: "b7e042",
    content: "Room 3 is open - next patient can be roomed.",
    scope: "My care team (8)",
    date: "Aug 3, 2026",
    retain: "Aug 3, 2032",
    events: [{
      t: "08:51:10",
...
function Rb({
  ...
  let Se = l === "manager",
    ...
    ul = () => {
      ...
      let y = {
        event: ae.event.trim(),
        wager: ae.wager.trim() || "Losers wear the winner's colors. Both sides give to charity - the app keeps score.",
        sideA: {
          name: ae.aName.trim(),
          color: ae.aColor
        },
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("button", {
        ...
        children: [(0, i.jsx)(Me, {
          size: 16
        }), " ", Se ? "Department console" : "Admin console"]
      }), (0, i.jsxs)("div", {
        style: {
          display: "flex",
          alignItems: "center",
        ...
        children: [(0, i.jsx)(St, {
          ...
          children: Se ? "Your department" : "Audit Log"
        })]
      }), (0, i.jsx)("div", {
        style: {
          fontFamily: p,
        ...
        children: Se ? Ha + " \xB7 approvals & members" : "Secure Messaging \xB7 immutable \xB7 retained 6 years"
      })]
    }), Se ? (0, i.jsxs)("div", {
      style: {
        display: "flex",
      ...
      style: {
        ...
        gap: 6,
        margin: "0 14px 10px",
        background: "rgba(224,154,56,0.12)",
        borderRadius: 10,
        padding: "8px 10px"
      },
      children: [(0, i.jsx)(to, {
        ...
        children: ["Admins & compliance only. Your access to this log is itself recorded - event #L-5567, ", Br[0] && Br[0].name || "you", ", 09:41."]
      })]
    }), s && (0, i.jsxs)("div", {
      style: {
        margin: "0 14px 10px",
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(Ne, {
            ...
            children: [(0, i.jsx)("div", {
              ...
              children: [y.dept, y.isMe ? " \xB7 you" : ""]
            })]
          }), (0, i.jsx)("button", {
            disabled: y.isMe,
            onClick: () => {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: "Fresh set every two weeks. Tap your pick \u2014 see where the whole clinic lands."
        }), ja.map(q => {
          let ke = It[q.id],
            je = q.av + q.bv || 1,
            Ct = Math.round(q.av / je * 100),
            ta = (Sa, Pr, ka, xo) => {
              let qa = ke === Sa;
              return (0, i.jsxs)("button", {
                ...
                style: {
                  ...
                  position: "relative",
                  overflow: "hidden",
                  border: "1px solid " + (qa ? d.pine : d.line),
                  background: "#fff",
                  borderRadius: 12,
                  padding: "8px 11px",
                  cursor: "pointer"
                ...
                children: [(0, i.jsx)("div", {
                  style: {
                    ...
                    bottom: 0,
                    width: xo + "%",
                    background: qa ? d.pine + "22" : d.honey + "1A"
                  }
                }), (0, i.jsxs)("div", {
                  style: {
                    position: "relative",
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
              ...
              children: [ta("a", q.a, q.av, Ct), ta("b", q.b, q.bv, 100 - Ct)]
            }), ke && (0, i.jsxs)("div", {
              style: {
                fontFamily: p,
                fontSize: 10.5,
              ...
              children: ["You're one of ", ke === "a" ? q.av : q.bv, " who chose ", ke === "a" ? q.a : q.b, "."]
            })]
          }, q.id)
        })]
      }), (0, i.jsx)("div", {
        ...
        }), "Self-serve for now. Manager approval is a per-tenant setting for larger organizations."]
      }), $ ? (0, i.jsxs)("div", {
        ...
        children: "Restart onboarding (demo)"
      }), (0, i.jsx)("div", {
        style: {
          textAlign: "center",
          marginTop: 14,
...
function zb({
  ...
  let [m, g] = (0, I.useState)(null), [b, k] = (0, I.useState)(null), [A, v] = (0, I.useState)(null), [x, w] = (0, I.useState)(!1), [_, C] = (0, I.useState)(!1), [E, P] = (0, I.useState)(null), [W, K] = (0, I.useState)(new Set), [B, X] = (0, I.useState)(null), [ne, Ye] = (0, I.useState)([]), [Ut, ja] = (0, I.useState)([]), [It, $] = (0, I.useState)({
    title: "",
    url: "",
    open: !0,
    deadline: ""
  ...
  let [Fr, Mn] = (0, I.useState)([]), [Zs, $a] = (0, I.useState)(""), ba = (0, I.useCallback)(async () => {
    ...
    let pt = T.map(Ce => {
        let ei = (Y || []).filter(oh => oh.thread_id === Ce && oh.profile_id !== e.id)[0],
          ti = Q[Ce];
        return {
          id: Ce,
          kind: "dm",
          name: ei && ei.profiles ? ei.profiles.display_name : "Someone",
          otherId: ei ? ei.profile_id : null,
  ...
  let el = async (S, L, T) => {
    ...
    let {
      data: L
    } = await F.from("group_members").select("profile_id, profiles(display_name, dept)").eq("group_slug", S).limit(12);
    wo((L || []).map(T => ({
      id: T.profile_id,
      name: T.profiles && T.profiles.display_name || "Someone",
      role: T.profiles && T.profiles.dept || "SOG"
    })))
  ...
  let Ga = t && t.display_name || mo,
    ...
    ol = async (S, L) => {
      ...
      L && At(L.message), ra()
    }, [ko, Cd] = (0, I.useState)([]), [se, oa] = (0, I.useState)([]), [Nt, il] = (0, I.useState)([]), [Hn, qn] = (0, I.useState)({
      msg: "",
      on: !1
    }), [_d, ot] = (0, I.useState)(""), [$n, bo] = (0, I.useState)(!1), Lo = (0, I.useCallback)(async () => {
      let [S, L, T, U] = await Promise.all([F.from("birthdays").select("id, name, month, day").order("month").order("day"), F.from("anniversaries").select("id, name, month, day, year").order("month").order("day"), F.from("recognition").select("*").order("posted_at", {
        ascending: !1
      }), F.from("app_settings").select("key, value").eq("key", "cupcake").maybeSingle()]);
  ...
  let Ov = nt.filter(S => Dd.indexOf(S.id) !== -1),
    ...
    Yn = (0, I.useCallback)(async () => {
      let {
        data: S,
        error: L
      } = await F.from("profiles").select("id, display_name, dept, title, role, active, created_at, department_members(department_id)").order("display_name");
      if (L) {
        vl(L.message);
        return
      }
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("style", {
      children: "@import url('https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400..800&family=Hanken+Grotesk:wght@400..700&display=swap'); *::-webkit-scrollbar{width:0;height:0} ::placeholder{color:#8C9691;opacity:1}"
    }), (0, i.jsxs)("div", {
      style: {
        width: 400,
        maxWidth: "100%",
